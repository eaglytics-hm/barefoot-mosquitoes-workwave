...
export const Invoice = createWebhookModel({
    ...
    schema: Joi.object({
        ...
        Tax: NumericField,
        TaxDetails: Joi.array().items(TaxDetailsFields),
        Total: NumericField,
        Balance: NumericField,
        Cost: NumericField,
        ...
        MaterialApplications: Joi.array().items({
            ...
            AreasApplied: Joi.array().items(Joi.string(), StringField.strip()),
            TargetPests: Joi.array().items(Joi.string(), StringField.strip()),
            TargetPestDescriptions: Joi.array().items(Joi.string(), StringField.strip()),
        }),
        TargetPests: Joi.array().items(Joi.string(), StringField.strip()),
        ...
        UserDefinedFields: Joi.array().items(UserDefinedFields),
